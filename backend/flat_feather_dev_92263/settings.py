"""
Django settings for flat_feather_dev_92263 project.
...
ROOT_URLCONF = 'flat_feather_dev_92263.urls'
...
WSGI_APPLICATION = 'flat_feather_dev_92263.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flat_feather_dev_92263 API",
    "DESCRIPTION": "API documentation for flat_feather_dev_92263 App",
    "VERSION": "v1",
}
